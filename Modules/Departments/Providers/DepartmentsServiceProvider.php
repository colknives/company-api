...
use Modules\Departments\Services\DepartmentInterface;
...
class DepartmentsServiceProvider extends ServiceProvider
{
    ...
    public function boot(Router $router)
    {
        ...
        $router->aliasMiddleware('department-auth', \Modules\Departments\Http\Middleware\DepartmentTokenMiddleware::class);
    }
